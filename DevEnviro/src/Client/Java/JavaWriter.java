...
public class JavaWriter extends ElementWriter {
    ...
    private void Init() {
        ...
        // class name
        addLine(String.format("public class %s {", getFileName()));
    ...
    public void run() {
        ...
        Thread t = new Thread(() -> {
            ...
            try {
                String runtimePath = os.contains("win") ? "\"C:\\Program Files\\Java\\jdk1.8.0_161\\bin\\java\"" :
    ...
    public void Compile() {
        ...
        Thread t = new Thread(() -> {
            ...
            try {
                String compilerPath = os.contains("win") ? "\"C:\\Program Files\\Java\\jdk1.8.0_161\\bin\\javac.exe\"" :
                        DevEnvironment.executeCommand("which javac", true);
