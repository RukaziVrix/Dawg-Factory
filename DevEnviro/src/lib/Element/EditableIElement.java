...
public class EditableIElement  extends UIElement {

    protected JBoundingBox m_boundingBox;
    ...
    public EditableIElement(UIElement element) {
        m_element = element;
        m_boundingBox = new JBoundingBox(m_element);
    }
    ...
    protected Point[] getResizePoints(Point curPt) {
        ...
        switch (direction) {
            case JBoundingBox.RESIZE_NORTH: 	 	// intentional fallthrough
            case JBoundingBox.RESIZE_NORTH_EAST:
            case JBoundingBox.RESIZE_NORTH_WEST:
                if (curPt.y > endPt.y) {
                ...
                break;
            case JBoundingBox.RESIZE_SOUTH: 		// intentional fallthrough
            case JBoundingBox.RESIZE_SOUTH_EAST:
            case JBoundingBox.RESIZE_SOUTH_WEST:
        ...
        switch (direction) {
            case JBoundingBox.RESIZE_EAST: 		// intentional fallthrough
            case JBoundingBox.RESIZE_NORTH_EAST:
            case JBoundingBox.RESIZE_SOUTH_EAST:
                ...
                break;
            case JBoundingBox.RESIZE_WEST: 		// intentional fallthrough
            case JBoundingBox.RESIZE_NORTH_WEST:
            case JBoundingBox.RESIZE_SOUTH_WEST:
                if (curPt.x > endPt.x) {
